...
# https://github.com/sevenseacat/tunez/blob/end-of-chapter-2/mix.exs

# ------------------------------------------------------------------------------
# Context: Uncommenting the second seed file so that `mix seed` can
# import Artist and Album data into the database
defp aliases do
  [
