...
# https://github.com/sevenseacat/tunez/blob/end-of-chapter-1/mix.exs

# ------------------------------------------------------------------------------
# Context: Uncommenting the first seed file so that `mix seed` can
# import Artist data into the database
defp aliases do
  [
